            ...
            <div className='flex'>
                <Toaster />
                {
                    ...
                    <div className='border-2 border-green-100'>
                        ...
                        <div className='h-[83vh] w-[33vw] m-2 overflow-x-hidden scrollbarHide flex flex-col items-center'>
                            {
                                        ...
                                        <div key={paper.paper_title} className='w-full border-2 border-green-200 m-2 flex flex-col items-center justify-center'>
                                            <div className='flex flex-col items-center justify-center'>
                                                <div className='flex flex-wrap flex-col items-center justify-center'>
                                                    <h3 className='font-bold text-xl p-4 bg-green-50'>{paper.paper_title}</h3>
                ...
                <div className='w-full h-[98vh] flex flex-col overflow-y-scroll items-center'>
                    {
                        ...
                        <motion.div
                            ...
                            <form onSubmit={handleSubmit} className="flex rounded-full border-2 p-1 ml-12 items-center justify-center">
                                <input type="text" className="bg-white mt-2 text-green-600 focus:outline-none px-4 w-[40vw]" value={newQuery} onChange={(e) => setNewQuery(e.target.value)} placeholder="eg: GPT-3 Stable Diffusion etc..." />
                                ...
                                <div className="items-center flex p-2 sm:text-left">
                                    ...
                                    </button>
                                    {
                                        ...
                                        <motion.div
                                            ...
                                            className="absolute flex flex-col top-14 right-12 mt-2 bg-white rounded-md shadow-xl py-1">
                                            <Link className='flex items-center hover:bg-gray-50 m-1 p-2 px-4 text-sm text-center' href="/profile">
                                                <AiOutlineUser className='mr-2' />Profile
                                            </Link>
                                            <Link className='flex items-center hover:bg-gray-50 m-1 p-2 px-4 text-sm text-center' href="/api/auth/logout">
                    ...
                    }
                    {
                        ...
                        <motion.div
                            ...
                            <div className='flex bg-slate-100 glass rounded-md flex-col items-center justify-center p-8 border border-black'>
                                <RoughNotation animationDelay={1000} animationDuration={2000} type="highlight" color='#cef2c4' show={modal}>
