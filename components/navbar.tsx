        ...
        <div className="items-center flex p-2 sm:text-left">
          ...
          {userProfileMenu && (
            ...
            >
              ...
              <form
                className="flex p-2 m-1 mt-0 "
                onSubmit={handleAPIKeySubmit}
              >
                <input
                  type="text"
                  className="text-gray-800 p-2 bg-transparent focus:outline-none text-sm border w-[90%] placeholder:text-gray-500"
                  value={apiKey}
                  onChange={e => setApiKey(e.target.value)}
                  placeholder="Open AI API key here"
                />
                <button className="text-sm ml-2" type="submit">
                  <AiOutlineEdit />
                </button>
              </form>
            </motion.div>
